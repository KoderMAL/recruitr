...
class MeetingsTest < ApplicationSystemTestCase
  ...
  test "creating a Meeting" do
    ...
    fill_in "Ends on", with: @meeting.ends_on
    fill_in "Participant", with: @meeting.participant_id
    fill_in "Recruiter", with: @meeting.recruiter_id
    fill_in "Starts on", with: @meeting.starts_on
